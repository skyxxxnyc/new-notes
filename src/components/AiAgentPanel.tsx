...
export default function AiAgentPanel({ onClose }: AiAgentPanelProps) {
      ...
      const defaultAgents = [
        {
          ...
          icon: 'Bot',
          instructions: 'You are a workspace assistant. You can help users manage their pages and databases.',
          knowledge_sources: [],
        ...
        },
        {
          ...
          icon: 'Database',
          instructions: 'You are a task management assistant. You understand task titles, statuses, and deadlines. Help the user organize and manage their tasks effectively.',
  ...
  return (
    <div className="flex flex-col h-full bg-white border-l border-slate-200 shadow-2xl w-[400px] animate-in slide-in-from-right duration-300">
      {showManagement ? (
        <AgentManagement 
